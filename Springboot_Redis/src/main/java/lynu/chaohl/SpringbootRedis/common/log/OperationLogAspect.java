...
import lynu.chaohl.SpringbootRedis.utils.JacksonJsonUtils;
import lynu.chaohl.SpringbootRedis.utils.StringUtils;
...
public class OperationLogAspect {
    ...
    //定义切点 @Pointcut
    //在注解的位置切入代码
    @Pointcut("@annotation(lynu.chaohl.SpringbootRedis.common.log.OperationLog)")
